...
<p class="caption">(\#fig:p2)各语言文本示例</p>
</div>
...
<p class="caption">(\#fig:p3)斜体与粗细示例</p>
</div>
...
<table>
<caption>(\#tab:t2)MarkupText类的方法与属性</caption>
 <thead>
  <tr>
   <th style="text-align:center;"> 方法 </th>
   <th style="text-align:center;"> 属性 </th>
...
<p class="caption">(\#fig:p7)span示例</p>
</div>
...
<p class="caption">(\#fig:p8)gradient示例</p>
</div>
...
<table>
<caption>(\#tab:t3)Paragraph类的方法与属性</caption>
 <thead>
  <tr>
   <th style="text-align:center;"> 方法 </th>
   <th style="text-align:center;"> 属性 </th>
...
<table>
<caption>(\#tab:t4)Tex类的方法与属性</caption>
 <thead>
  <tr>
   <th style="text-align:center;"> 方法 </th>
   <th style="text-align:center;"> 属性 </th>
...
<table>
<caption>(\#tab:t5)MathTex类的方法与属性</caption>
 <thead>
  <tr>
   <th style="text-align:center;"> 方法 </th>
   <th style="text-align:center;"> 属性 </th>
...
<p class="caption">(\#fig:p11)MathTex示例</p>
</div>
...
<p class="caption">(\#fig:p12)子字符串上色示例</p>
</div>
...
<p class="caption">(\#fig:p13)目标字符上色示例</p>
</div>
...
<p class="caption">(\#fig:p14)目标字符上色示例</p>
</div>
...
<table>
<caption>(\#tab:t6)Title类的方法与属性</caption>
 <thead>
  <tr>
   <th style="text-align:center;"> 方法 </th>
   <th style="text-align:center;"> 属性 </th>
...
<table>
<caption>(\#tab:t7)Title类的方法与属性</caption>
 <thead>
  <tr>
   <th style="text-align:center;"> 方法 </th>
   <th style="text-align:center;"> 属性 </th>
