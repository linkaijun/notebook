...
1. 信息增益
   ...
   $$
   \textrm{Ent}(D)=-\sum_{m=1}^Mp_m \log_2p_m (\#eq:eq1)
   $$
   ...
   $$
   \textrm{Gain}(D,x)=\textrm{Ent}(D)-\sum_{v=1}^V\frac{n_v}{n}\textrm{Ent}(D^v) (\#eq:eq2)
   $$
...
2. 增益率
   ...
   $$
   \textrm{Gain_ratio}(D,x)=\frac{\textrm{Gain}(D,x)}{\textrm{IV(x)}} (\#eq:eq3)
   $$
   
   其中
   
   $$
   \textrm{IV}(x)=-\sum_{v=1}^V\frac{n_v}{n}\textrm{log}_2\frac{n_v}{n} (\#eq:eq4)
   $$
...
3. 基尼系数
   ...
   $$
   \textrm{Gini}(D)=\sum_{m=1}^Mp_m(1-p_m)=1-\sum_{m=1}^Mp_m^2 (\#eq:eq5) 
   $$
...
<img src="05-randomforest_files/figure-html/tree-p1-1.png" alt="袋外数据的分类错误率" width="672" />
...
<div class="figure" style="text-align: center">
<img src="05-randomforest_files/figure-html/tree-p2-1.png" alt="分类_重要性度量" width="672" />
...
<div class="figure" style="text-align: center">
<img src="05-randomforest_files/figure-html/tree-p3-1.png" alt="分类_mtry调优" width="672" />
...
<div class="figure" style="text-align: center">
<img src="05-randomforest_files/figure-html/tree-p4-1.png" alt="袋外数据MSE" width="672" />
...
<div class="figure" style="text-align: center">
<img src="05-randomforest_files/figure-html/tree-p5-1.png" alt="回归_重要性度量" width="672" />
...
<div class="figure" style="text-align: center">
<img src="05-randomforest_files/figure-html/tree-p6-1.png" alt="回归_mtry调优" width="672" />
