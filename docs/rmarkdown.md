...
-   fig.keep
    ...
    -   high
        ...
        <img src="rmarkdown_files/figure-html/unnamed-chunk-25-1.png" width="672" />
    ...
    -   all
        ...
        <img src="rmarkdown_files/figure-html/unnamed-chunk-27-1.png" width="672" />
        ...
        <img src="rmarkdown_files/figure-html/unnamed-chunk-27-2.png" width="672" />
        
        ``` r
        abline(1,-1)
        ```
        
        <img src="rmarkdown_files/figure-html/unnamed-chunk-27-3.png" width="672" />
    ...
    -   first
        ...
        <img src="rmarkdown_files/figure-html/unnamed-chunk-28-1.png" width="672" />
    ...
    -   last
        ...
        <img src="rmarkdown_files/figure-html/unnamed-chunk-29-1.png" width="672" />
    ...
    -   数值向量
        ...
        <img src="rmarkdown_files/figure-html/unnamed-chunk-30-1.png" width="672" />
...
-   fig.show
    ...
    -   asis
        ...
        <img src="rmarkdown_files/figure-html/unnamed-chunk-31-1.png" width="672" />
        ...
        <img src="rmarkdown_files/figure-html/unnamed-chunk-31-2.png" width="672" />
    ...
    -   hold
        ...
        <img src="rmarkdown_files/figure-html/unnamed-chunk-32-1.png" width="672" /><img src="rmarkdown_files/figure-html/unnamed-chunk-32-2.png" width="672" />
    ...
    -   animate
        ...
        <img src="rmarkdown_files/figure-html/unnamed-chunk-33-.gif" width="672" />
...
```{=html}
<div id="htmlwidget-0040243e0ae4bac3e24d" style="width:400px;height:100px;" class="grViz html-widget"></div>
<script type="application/json" data-for="htmlwidget-0040243e0ae4bac3e24d">{"x":{"diagram":"digraph {\n  graph [layout = dot, rankdir = LR]\n  \n  node [shape = box]        \n  rec1 [label = \"Step 1 打开冰箱\"]\n  rec2 [label = \"Step 2 塞入大象\"]\n  rec3 [label = \"Step 3 关上冰箱\"]\n  \n  rec1 -> rec2 -> rec3\n  }","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script>
```
...
```{=html}
<div id="htmlwidget-d9307d9fcafd00e56554" style="width:400px;height:100px;" class="DiagrammeR html-widget"></div>
<script type="application/json" data-for="htmlwidget-d9307d9fcafd00e56554">{"x":{"diagram":"\n  graph LR\n  node_1[Step 1 打开冰箱] --> node_2[Step 2 塞入大象]\n  node_2[Step 2 塞入大象] --> node_3[Step 3 关上冰箱]\n  "},"evals":[],"jsHooks":[]}</script>
```
