...
``` r
knitr::include_graphics(path = 'E:/R/rmarkdown/notebook/pic/shiny/statuses.png')
```
...
``` r
knitr::include_graphics(path = 'E:/R/rmarkdown/notebook/pic/shiny/colors.png')
```
